...
last_month_df = st.secrets["AMAZON_ADS_LAST_MONTH"]
compare_df = st.secrets["AMAZON_COMPARE"]
budgets = st.secrets["AMAZON_BUDGETS"]
amazon_meta_monthly = st.secrets["AMAZON_META_MONTHLY"]
...
# Add figure title
fig.update_layout(
    title_text="<b>Revenue Over Time vs FB Spend</b>"
)
...
#st.markdown('Amazon Ads monthly data to be added...eventually...')
st.plotly_chart(fig)
