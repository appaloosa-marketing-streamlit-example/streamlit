...
#SECRETS
sellercentral_monthly = st.secrets["AMAZON_SALES_MONTHLY_CA"]
sellercentral_mtd = st.secrets["AMAZON_SALES_MTD_CA"]
amazonads_mtd = st.secrets["AMAZON_ADS_CA_MTD"]
last_month_df = st.secrets["AMAZON_ADS_CA_LAST_MONTH"]
compare_df = st.secrets["AMAZON_CA_COMPARE"]
budgets = st.secrets["AMAZON_CA_BUDGETS"]
amazon_meta_monthly = st.secrets["AMAZON_CA_META_MONTHLY"]
amazon_meta_budgets = st.secrets["AMAZON_CA_META_BUDGETS"]
